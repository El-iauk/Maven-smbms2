                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList}" varStatus="status">
					<tr>
						...
						<td>
							<input type="hidden" id="a" value="${pageContext.servletContext.contextPath}">
							<span><a class="viewUser" href="${pageContext.request.contextPath }/user/getUserById.do?id=${user.id}"><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
						...
						<span>
							<a class="deleteUser" href="javascript:;" userid=${user.id } username=${user.userName }>
								<img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
						</td>
					</tr>
				</c:forEach>
			</table>
			<input type="hidden" id="totalPageCount" value="${pageSupport.getTotalCount()}"/>
		  	<c:import url="../rollpage.jsp">
	          	...
	          	<c:param name="totalPageCount" value="${pageSupport.getTotalCount()}"/>
          	</c:import>
        </div>
    </section>
<!--点击删除按钮后弹出的页面-->
